...
import { MapPin, Plus, MessageCircle, UserPlus } from 'lucide-react'
  ...
  return (
    <div className='p-4 pt-6 flex flex-col justify-between w-72 shadow border border-gray-200 rounded-md' key={user._id}>
        ...
        <div className='flex mt-4 gap-2'>
            {/* Following button */}
            <button disabled={currentUser.following.includes(user._id)} onClick={handleFollow} className='w-full py-2 rounded-md flex justify-center hover:from-indigo-600 hover:to-purple-700 bg-gradient-to-r from-indigo-500 to-purple-600 active:scale-95 transition text-white cursor-pointer'>
