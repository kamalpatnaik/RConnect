                  ...
                  <div className="flex max-sm:flex-col gap-2 mt-4">
                    {
                      <button
                        ...
                        className="w-full p-2 text-sm rounded bg-gradient-to-r from-indigo-500 to-purple-700 active:9s transition text-white cursor-pointer"
                      >
                        View Profile
                      </button>
                    }
                    ...
                    {currentTab === 'Connections' && (
                      <button
                        ...
                        className="w-full p-2 text-sm rounded bg-slate-100 hover:bg-slate-200 text-slate-800 active:scale-95 flex gap-1 transition cursor-pointer"
                      >
