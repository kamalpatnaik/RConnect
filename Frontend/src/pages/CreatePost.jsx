    ...
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
      <div className='max-w-6xl mx-auto p-6'>
        <div className='mb-8'>
          ...
          <p className='text-slate-600'> Create a new post</p>
        </div>
        {/* form */}
        <div className='max-w-xl bg-white p-4 sm:pb-3 rounded-xl shadow-md space-y-4'>
          ...
          {/* text area */}
          <textarea className='w-full resize-none max-h-20 mt-4 text-sm outline-none placeholder-gray-400' placeholder='write a thoughr' setContent={(e)=>{e.target.value}} value={content}/>
            {/* images */}
            {
            ...
            <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
              ...
              })} className='text-sm  bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95 transition text-white cursor-pointer font-medium px-8 py-2 rounded-md'>Publish Post</button>
            </div>
        </div>
      </div>
